        ...
        <a-tab-pane key="tab1" tab="账号密码登录">
          ...
          <a-form-item>
            <a-input
              ...
              v-decorator="[
                'userAccount',
                {rules: [{ required: true, message: '请输入账户名' }, { validator: handleuserAccountOrEmail }], validateTrigger: 'change'}
              ]"
            >
...
export default {
  ...
  data () {
    return {
      ...
      loginBtn: false,
      // login type: 0 email, 1 userAccount, 2 telephone
      loginType: 0,
      isLoginError: false,
  ...
  methods: {
    ...
    // handler
    handleuserAccountOrEmail (rule, value, callback) {
      const { state } = this
