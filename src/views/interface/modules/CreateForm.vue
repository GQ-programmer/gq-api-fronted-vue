    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout"  :wrapper-col="wrapperCol" :label-col="labelCol">
        ...
        <a-form-item label="请求参数">
          <a-textarea placeholder='请输入请求参数' :rows="3" v-decorator="['requestParams', {rules: [{required: true, min: 1, message: '请求参数不能为空！'}]}]" />
        </a-form-item>
...
// 表单字段
const fields = ['description', 'id', 'name', 'url', 'requestParams', 'requestHeader', 'responseHeader', 'method']
